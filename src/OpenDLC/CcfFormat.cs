...
{
    internal static readonly ReadOnlyCollection<byte[]> Keys = new(
    [
    ...
    internal static readonly ReadOnlyCollection<byte[]> IVs = new(
    [
    ...
    internal static readonly ReadOnlyCollection<Version> Versions = new(
    [
        new Version(1, 0),
        new Version(0, 8),
        new Version(0, 7)
